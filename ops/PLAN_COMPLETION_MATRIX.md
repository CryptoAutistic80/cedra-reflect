...
| Phase 3 — AMM and faucet | PASS (local) | `move/test-amm`; `move/test-assets`; 48 integration tests; Python and generated conformance witness | Exact-address release compilation, gas results, and finalized chain reconciliation |
...
| Unsupported delegated custody fails closed | PASS (local) | Explicit wallet registration, exact single custody binding, unsupported-store hook aborts, and no public adapter registrar |
