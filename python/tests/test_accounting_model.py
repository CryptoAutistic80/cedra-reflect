...
class RandomizedWorkloadHarnessTests(unittest.TestCase):
    ...
    def test_small_gate_counts_realized_transitions_and_serializes_report(self) -> None:
        ...
        self.assertEqual(report["schema"], "cedra-reflection-model-gate/v2")
        self.assertEqual(report["materialization_mode"], "automatic-interaction")
        self.assertIs(report["automatic_materialization"], True)
        self.assertEqual(report["lifecycle"], "LIVE")
