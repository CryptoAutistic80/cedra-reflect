...
module integration_tests::protocol_integration_tests {
    ...
    fun all_operator_primary_stores_are_excluded(core: &signer, assets: &signer, amm: &signer, framework: &signer) {
        setup(core, assets, amm, framework);
    ...
    fun publisher_handoff_assigns_all_routine_controls(
        ...
        reflection_token::set_operational_admin(core, operator_address);
        test_faucet::set_operational_admin(assets, operator_address);
        pool::set_operational_admin(amm, operator_address);
    ...
    fun core_publisher_loses_routine_authority_after_handoff(
        ...
        setup(core, assets, amm, framework);
        reflection_token::set_operational_admin(core, signer::address_of(operator));
        reflection_token::set_fee_bps(core, 0);
    }
    ...
    fun asset_publisher_loses_routine_authority_after_handoff(
        ...
        setup(core, assets, amm, framework);
        test_faucet::set_operational_admin(assets, signer::address_of(operator));
    ...
    fun amm_publisher_loses_routine_authority_after_handoff(
        ...
        setup(core, assets, amm, framework);
        pool::set_operational_admin(amm, signer::address_of(operator));
    ...
    #[test(core = @0xcafe, assets = @0xbabe, amm = @0xdead, framework = @0x1, alice = @0xa11ce)]
    #[expected_failure(abort_code = 5, location = reflection_core::reflection_token)]
